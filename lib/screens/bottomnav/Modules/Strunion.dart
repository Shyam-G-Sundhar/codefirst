...
class BtmStrUnion extends StatefulWidget {
  const BtmStrUnion({Key? key});

  @override
  State<BtmStrUnion> createState() => _BtmStrUnionState();
}

class _BtmStrUnionState extends State<BtmStrUnion> {
  ...
  void _loadDocuments() async {
    QuerySnapshot querySnapshot =
        await FirebaseFirestore.instance.collection('Structures & Union').get();
