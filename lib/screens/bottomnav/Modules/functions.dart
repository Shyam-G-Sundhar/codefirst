...
class BtmFunctions extends StatefulWidget {
  const BtmFunctions({Key? key});

  @override
  State<BtmFunctions> createState() => _BtmFunctionsState();
}

class _BtmFunctionsState extends State<BtmFunctions> {
  ...
  void _loadDocuments() async {
    QuerySnapshot querySnapshot =
        await FirebaseFirestore.instance.collection('Functions').get();
