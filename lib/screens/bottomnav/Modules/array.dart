...
class BtmArray extends StatefulWidget {
  const BtmArray({Key? key});

  @override
  State<BtmArray> createState() => _BtmArrayState();
}

class _BtmArrayState extends State<BtmArray> {
  ...
  void _loadDocuments() async {
    QuerySnapshot querySnapshot =
        await FirebaseFirestore.instance.collection('Array').get();
