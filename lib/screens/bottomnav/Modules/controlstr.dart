...
class BtmControlStructures extends StatefulWidget {
  const BtmControlStructures({Key? key});

  @override
  State<BtmControlStructures> createState() => _BtmControlStructuresState();
}

class _BtmControlStructuresState extends State<BtmControlStructures> {
  ...
  void _loadDocuments() async {
    QuerySnapshot querySnapshot =
        await FirebaseFirestore.instance.collection('Control Structures').get();
