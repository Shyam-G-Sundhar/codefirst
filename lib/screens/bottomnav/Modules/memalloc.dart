...
class BtmMemAlloc extends StatefulWidget {
  const BtmMemAlloc({Key? key});

  @override
  State<BtmMemAlloc> createState() => _BtmMemAllocState();
}

class _BtmMemAllocState extends State<BtmMemAlloc> {
  ...
  void _loadDocuments() async {
    QuerySnapshot querySnapshot =
        await FirebaseFirestore.instance.collection('Memory Allocation').get();
